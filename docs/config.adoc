...
Since the configuration is extensive, documentation has been broken down into several sections below. Visit the examples section for a <<examples#all-options,complete configuration file>>.
