...
idprovider.<idprovidername>.oidcWellKnownEndpoint= (string, optional) # if defined, then values for the rest of 4 props will be ignored
...
idprovider.<idprovidername>.mappings.displayName=  (string, required, default to ${preferred_username})
idprovider.<idprovidername>.mappings.email=  (string, required, default to ${email})
...
idprovider.<idprovidername>.handle401.enabled= (true|false, optional)

idprovider.<idprovidername>.autoLogin.enabled= (true|false, optional)
# if true, then claimDisplayName and claimEmail will be ignored
idprovider.<idprovidername>.autoLogin.useUserinfo= (true|false, optional)
idprovider.<idprovidername>.autoLogin.claimDisplayName=  (string, optional)
idprovider.<idprovidername>.autoLogin.claimEmail=  (string, optional)
idprovider.<idprovidername>.autoLogin.createUsers=  (true|false, optional)
idprovider.<idprovidername>.autoLogin.createSession=  (true|false, optional)
idprovider.<idprovidername>.autoLogin.retrievalQueryParameter=  (string, optional)
idprovider.<idprovidername>.autoLogin.retrievalWsHeader=  (true|false, optional)
idprovider.<idprovidername>.autoLogin.validationAllowedSubjects=  (space separated strings, optional)
----
