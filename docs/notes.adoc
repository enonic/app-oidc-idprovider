...
This version introduces breaking changes to how the Redirect URI is constructed, which require updating the callbacks in your ID Provider.

The Redirect URI now matches virtual host source path mapping. Thanks to these changes, deep links will be handled correctly.
