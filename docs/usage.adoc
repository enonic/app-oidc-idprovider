...
NOTE: Your Enonic ID provider should automatically be create once you add your configuration file


=== Manual setup

If you disable `autoInit`, the ID providers may manually by created by following these steps:
...
Edit the XP configuration file `com.enonic.xp.web.vhost.cfg`, and map the id provider to your a vhost.
